...
function FormField({
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="h-9 flex items-start mt-1">
        {error && (
          <p className="text-xs text-red-500 leading-tight animate-in fade-in duration-200">
            {error.message}
          </p>
        )}
      </div>
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col justify-center items-center p-4 bg-surface">
      <div className="mb-6 text-center flex gap-1 justify-center items-center">
        <Image
          src="/logo.png"
          alt="Dockly Logo"
          width={32}
        ...
        />
        <span className="text-headline-md font-black text-on-surface">
          Dockly
        </span>
      </div>

      <div className="w-full max-w-110 bg-surface-container-lowest rounded-xl shadow-[0px_20px_25px_-5px_rgba(15,23,42,0.1)] border border-outline-variant/30 p-6 sm:p-8">
        ...
        <div className="mt-6">
          <Button
            variant={"outline"}
            className="w-full h-11 flex justify-center items-center px-4 rounded-lg text-on-surface font-label-md text-label-md shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary active:scale-95"
          >
            <svg
        ...
        <div className="mt-6 text-center font-body-md text-body-md text-on-surface-variant">
          Don't have an account?{" "}
          <Link
            className="font-label-md text-label-md text-secondary hover:text-secondary-container transition-colors"
            href="register"
